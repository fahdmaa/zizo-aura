<section id="hero-carousel-section" class="w-full relative overflow-hidden bg-white select-none border-b border-zinc-100" aria-label="Bannière principale zizo aura">
    ...
    <div id="heroCarouselStage" class="relative w-full overflow-hidden aspect-[1717/916] min-h-[260px] sm:min-h-[380px] md:min-h-[460px] lg:min-h-[540px] xl:min-h-[620px] bg-zinc-100">
        ...
        <div id="heroCarouselTrack" class="flex w-full h-full will-change-transform transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)]">
            ...
            <a href="{{ route('shop.category', 'sol-de-janeiro') }}" class="hero-slide w-full h-full shrink-0 relative block cursor-pointer" data-index="0" data-brand="sol-de-janeiro" role="group" aria-roledescription="slide" aria-label="1 sur 4 : Sol de Janeiro">
            ...
            <!-- Slide 2: Rituals -->
            <a href="{{ route('shop.category', 'rituals') }}" class="hero-slide w-full h-full shrink-0 relative block cursor-pointer" data-index="1" data-brand="rituals" role="group" aria-roledescription="slide" aria-label="2 sur 4 : Rituals">
            ...
            <a href="{{ route('shop.category', 'victorias-secret') }}" class="hero-slide w-full h-full shrink-0 relative block cursor-pointer" data-index="2" data-brand="victorias-secret" role="group" aria-roledescription="slide" aria-label="3 sur 4 : Victoria's Secret">
            ...
            <a href="{{ route('shop.category', 'the-ordinary') }}" class="hero-slide w-full h-full shrink-0 relative block cursor-pointer" data-index="3" data-brand="the-ordinary" role="group" aria-roledescription="slide" aria-label="4 sur 4 : The Ordinary">
